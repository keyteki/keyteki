...
2. Update `config/default.json5` so the server connects to the containerized databases:
...
4. In another terminal, run the game node:
...
3. Fetch card data and start servers:
