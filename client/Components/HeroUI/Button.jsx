...
const baseTextureClasses =
    'inline-flex items-center justify-center select-none cursor-pointer px-5 h-8 min-w-[130px] tracking-wide text-white font-[Keyforge,_Helvetica,_sans-serif] bg-center bg-no-repeat bg-[length:100%_100%] border-0 rounded-none !bg-transparent transition-all duration-200 ease-linear';
