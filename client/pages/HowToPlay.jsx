        ...
        return (
            <div className='col-xs-12 full-height'>
                <Panel title={ t('How To Play on The Crucible Online') }>
                    <a className='btn btn-danger pull-right' target='_blank' href='https://github.com/keyteki/keyteki/issues' rel='noopener noreferrer'><Trans>Report Problems</Trans></a>
