                ...
                <Panel title={t('About The Crucible Online - Help and information')}>
                    ...
                    <p>
                        <Trans i18nKey='about.whatisthis'>
                            ...
                            <p>
                                This site was setup to allow you to play Keyforge, a Unique Deck
                                Game from Fantasy Flight Games (FFG) in your browser.
                            </p>
                        </Trans>
                        ...
                        <Trans i18nKey='about.whydiscarded'>
                            <h3>
                                Why do my best cards always get discarded? / Why do I/my opponent
                                draw 6 brobnar cards every turn?
                            </h3>
                            <p>
                                This is question that gets asked a lot (usually less politely!). The
                                shuffle code is fine. It uses a Fisher-Yates algorithm which is the
                                best card shuffling algorithm available. Real randomness can be
                                quite jarring when you&apos;re used to imperfect human shuffling.
                                But why believe me? Believe the numbers:
                            </p>
                            <p>
                            ...
                            <p>
                                That said, if you can prove there is a bug, please do raise an issue
                                on GitHub!
                            </p>
                        </Trans>
                        ...
                        <Trans i18nKey='about.colors'>
                            ...
                            <p>
                                Some usernames have different colors and the intent is to
                                acknowledge the supporters of the platform:
                            </p>
                            <ul>
                                <li>
                                ...
                                <li>
                                    ...
                                    people who have made significant development contributions to
                                    the site
                                </li>
                                <li>
                                    <span className='username supporter-role'>supporter</span> -
                                    patreon supporters
                                </li>
                                <li>
                        ...
                        <Trans i18nKey='about.addnotes'>
                            ...
                            <p>
                                The Keyforge Unique Deck Game, the artwork and many other things are
                                all copyright Fantasy Flight Games and I make no claims of ownership
                                or otherwise of any of the artwork or trademarks. This site exists
                                for passionate fans to play a game they enjoy and augment, rather
                                than replace, the in person LCG. FFG does not endorse, support, and
