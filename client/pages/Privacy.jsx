            ...
            <Panel title={t('Privacy Policy')}>
                ...
                <p>
                    <Trans i18nKey='privacy.background'>
                        Even though this is only a site to play a card game online, we still take
                        your privacy and the security of your data seriously. This policy outlines
                        what data we store about you, why we store it and what we do with it.
                    </Trans>
                </p>
                ...
                <Trans i18nKey='privacy.whatwestore'>
                    ...
                    <p>
                        ...
                        play(the deck you are using to play with, who you are playing against and
                ...
                <p>
                    <Trans i18nKey='privacy.why'>
                        We collect a username to identify you on the site and so that people know
                ...
                <p>
                    <Trans i18nKey='privacy.ipaddress'>
                        ...
                        security and integrity of the site and allow us to prevent abuse of the
                        site.
                    </Trans>
                </p>
                <p>
                    <Trans i18nKey='privacy.lobby'>
                        Your lobby messages are stored so that we can display them to other users of
                        the site and to detect patterns of abusive behaviour. Your messages may also
                        be moderated to remove offensive content, or deleted altogether at our
                        discretion.
                    </Trans>
                </p>
            </Panel>
