            ...
            return (
                <div className='dynasty-row'>
                    <div className='deck-cards'>
                        ...
                        <Province source='province 1' cards={this.props.province1Cards} onMouseOver={this.props.onMouseOver} onMouseOut={this.onMouseOut} onDragDrop={this.props.onDragDrop} hiddenProvinceCard='true' hiddenDynastyCard='true' />
                        <Province source='province 2' cards={this.props.province2Cards} onMouseOver={this.props.onMouseOver} onMouseOut={this.onMouseOut} onDragDrop={this.props.onDragDrop} hiddenProvinceCard='true' hiddenDynastyCard='true' />
                        <Province source='province 3' cards={this.props.province3Cards} onMouseOver={this.props.onMouseOver} onMouseOut={this.onMouseOut} onDragDrop={this.props.onDragDrop} hiddenProvinceCard='true' hiddenDynastyCard='true' />
                        <Province source='province 4' cards={this.props.province4Cards} onMouseOver={this.props.onMouseOver} onMouseOut={this.onMouseOut} onDragDrop={this.props.onDragDrop} hiddenProvinceCard='true' hiddenDynastyCard='true' />
                ...
                <div className='dynasty-row'>
                    <div className='deck-cards'>
                        ...
                        <CardCollection className='conflict deck' title='Conflict' source='conflict deck' cards={this.props.conflictDeck}
                                    ...
                                    menu={conflictDeckMenu} hiddenTopCard cardCount={this.props.numConflictCards} popupMenu={conflictDeckPopupMenu} />
                        {/* Add Provinces in here */}
                        <Province source='province 4' cards={this.props.province4Cards} onMouseOver={this.props.onMouseOver} onMouseOut={this.onMouseOut} hiddenProvinceCard='true' hiddenDynastyCard='true' />
                        <Province source='province 3' cards={this.props.province3Cards} onMouseOver={this.props.onMouseOver} onMouseOut={this.onMouseOut} hiddenProvinceCard='true' hiddenDynastyCard='true' />
                        <Province source='province 2' cards={this.props.province2Cards} onMouseOver={this.props.onMouseOver} onMouseOut={this.onMouseOut} hiddenProvinceCard='true' hiddenDynastyCard='true' />
                        <Province source='province 1' cards={this.props.province1Cards} onMouseOver={this.props.onMouseOver} onMouseOut={this.onMouseOut} hiddenProvinceCard='true' hiddenDynastyCard='true' />
