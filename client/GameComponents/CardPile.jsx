...
class CardPile extends React.Component {
    ...
    render() {
        ...
        if(this.props.hiddenTopCard && !this.props.topCard && cardCount > 0) {
            topCard = { facedown: true, cardback: this.props.cardback };
        }
...
CardPile.propTypes = {
    ...
    source: PropTypes.oneOf(['archives', 'purged', 'discard', 'deck', 'none', 'hand', 'conflict discard pile', 'dynasty discard pile', 'play area', 'conflict deck', 'dynasty deck', 'province deck', 'attachment', 'faction', 'stronghold province', 'role card', 'province 1', 'province 2', 'province 3', 'province 4', 'additional']).isRequired,
