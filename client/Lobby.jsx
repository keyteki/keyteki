        ...
        return (
            <div>
                <div className='alert alert-info'>
                    <div><span className='icon-intrigue' />2017-01-14: New cards: For The Watch!, Blood Of The Dragon, Pukking The Strings, Varys's Riddle, Famine, Fallen From Favor, Weapons At The Door, Ranger's Cache, Lions of the Rock, Unexpected Delay, Littlefinger's Meddling.  There are now only a small amount of plots not implemented (less than 10).  Fixed a bug causing cards that got returned to hand not be able to be saved.  Fix a bug causing take control effects to make cards unavailable for challenges</div> 
