        ...
        return (
            <div>
                <div className='alert alert-info'>
                    <div><span className='icon-military' />2017-01-17: New cards: King's Hunting Party, Vanguard Lancer, Aeron Damphair, Balon Greyjoy, The Kraken's Grasp, Cersei Lannister (Core), Joffrey Baratheon (Core), Doran Martell.  Duplicates are no longer considered in play for card effects</div>
