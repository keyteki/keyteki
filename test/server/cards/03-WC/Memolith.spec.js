    ...
    integration(function() {
        describe('Memolith\'s ability', function() {
            ...
            it('should do nothing when there is no action in the hand or grafted card', function() {
                ...
                expect(this.player1).not.toHavePromptButton('Graft an action card');
                expect(this.player1).not.toHavePromptButton('Trigger play effect');
        ...
        describe('Memolith\'s ability', function() {
            beforeEach(function() {
                this.setupTest({
                    player1: {
                        house: 'brobnar',
                        inPlay: ['memolith'],
                        hand: ['pound', 'troll', 'anger', 'autocannon']
                    },
                    player2: {
                        inPlay: ['panpaca-anga', 'flaxia', 'tantadlin', 'bigtwig']
                    }
            ...
            it('should activate the play effect of a grafted card', function() {
                ...
                this.player1.useAction(this.memolith);
                expect(this.player1).toHavePrompt('Memolith');
                expect(this.player1).toHavePromptButton('Graft an action card');
                expect(this.player1).toHavePromptButton('Trigger play effect');
                this.player1.clickPrompt('Trigger play effect');
                expect(this.player1).toBeAbleToSelect(this.pound);
