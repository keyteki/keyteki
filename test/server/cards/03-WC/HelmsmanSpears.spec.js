describe("Helmsman Spears'", function () {
    describe("Helmsman Spears' ability", function () {
        ...
        it('should allow discarding cards with scrapt and drawing of the equal amount when reaping', function () {
            this.player1.reap(this.helmsmanSpears);
            ...
            // discarded 2 cards. Tautau Vapors was discarded by Helmsman
            // Spears.
