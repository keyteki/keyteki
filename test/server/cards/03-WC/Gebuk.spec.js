describe('Gebuk', function() {
    integration(function() {
        describe('when destroyed', function() {
            ...
            describe('and the top card of the deck is not a creature', function() {
                beforeEach(function() {
            ...
            describe('and the top card of the deck is a creature', function() {
                ...
                fit('should put that creature into play in the same position as gebuk was', function() {
