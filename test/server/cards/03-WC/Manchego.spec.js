describe('Manchego', function() {
    integration(function() {
        ...
        describe('Manchego\'s play ability', function() {
            ...
            it('should prompt to put manchego back in the deck when fighting and do it when you click yes', function() {
                this.player1.fightWith(this.manchego, this.nexus);
                expect(this.player1).toHavePrompt('Manchego');
            ...
            it('should prompt to put manchego back in the deck when fighting and not do it when you click no', function() {
                this.player1.fightWith(this.manchego, this.nexus);
                expect(this.player1).toHavePrompt('Manchego');
                expect(this.player1).toBeAbleToSelect(this.manchego);
                expect(this.player1).not.toBeAbleToSelect(this.mother);
            ...
            it('should prompt to put manchego back in the deck when reaping and do it when you click yes', function() {
            ...
            it('should prompt to put manchego back in the deck when reaping and not do it when you click no', function() {
                this.player1.reap(this.manchego);
                expect(this.player1).toHavePrompt('Manchego');
                expect(this.player1).toBeAbleToSelect(this.manchego);
                expect(this.player1).not.toBeAbleToSelect(this.mother);
