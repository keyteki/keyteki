describe('Xeno-Fiend', function () {
    describe("Xeno-Fiend's ability", function () {
        beforeEach(function () {
            this.setupTest({
                player1: {
                    house: 'dis',
        ...
        it('should steal 1A when destroyed', function () {
            this.player1.fightWith(this.xenoFiend, this.troll);
            expect(this.xenoFiend.location).toBe('discard');
        ...
        it('should not prompt for cards is deck is empty', function () {
            ...
            this.player1.fightWith(this.xenoFiend, this.lamindra);
            expect(this.player1).toHavePrompt('Choose a card to play, discard or use');
        });
