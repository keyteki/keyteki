describe('Lashing Tentacle', function () {
    describe("Lashing Tentacle's ability", function () {
        beforeEach(function () {
            this.setupTest({
                player1: {
                    house: 'keyraken',
        ...
        it('archives when put into play without friendly legendary keyraken in play', function () {
            ...
            this.player1.scrap(this.lashingTentacle);
        ...
        it('deals 3 damage to legendary keyraken when destroyed', function () {
            ...
            this.player2.play(this.wailOfTheDamned);
            this.player2.clickCard(this.lashingTentacle);
            expect(this.lashingTentacle.location).toBe('discard');
        ...
        it('has skirmish', function () {
            this.player1.playCreature(this.legendaryKeyraken0);
            this.player1.playCreature(this.lashingTentacle);
            expect(this.lashingTentacle.hasKeyword('skirmish')).toBe(true);
            expect(this.player1).isReadyToTakeAction();
        });
    });
});
