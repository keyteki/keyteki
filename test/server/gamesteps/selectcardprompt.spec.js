...
describe('the SelectCardPrompt', function() {
    ...
    beforeEach(function() {
        ...
        this.player = jasmine.createSpyObj('player1', ['setPrompt', 'cancelPrompt', 'clearSelectableCards', 'clearSelectedCards', 'setSelectableCards', 'setSelectedCards', 'clearSelectableRings']);
