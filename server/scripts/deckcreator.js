...
let decks = [];
let deckdata = [
    'Voltpixel, Underground Boss/Brobnar Logos Dis 010 013 016 020 027 030 032 036 039 046 049 051 056 059 059 067 067 077 077 077 085 095 097 102 109 125 125 129 132 136 139 142 142 143 144 147',
