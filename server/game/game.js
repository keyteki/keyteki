...
class Game extends EventEmitter {
    constructor(details, options = {}) {
        ...
        /**
         * {Array[string | {name: string, delay: 1-10}]} Contains all the
         * animations generated by game actions during the current turn.
         * See Amber.scss for available animations.
         */
        this.animations = [];
