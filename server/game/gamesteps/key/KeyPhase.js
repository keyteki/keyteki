...
class KeyPhase extends Phase {
    ...
    forgeKey() {
        if(this.game.activePlayer.canForgeKey()) {
            ...
            this.game.addMessage('{0} does not forge a key.  They have {1} amber.  The current cost is {2} amber ',
                this.game.activePlayer, this.game.activePlayer.amber, this.game.activePlayer.getCurrentKeyCost());
        }
    }
}
