...
class VenerableHistorian extends DrawCard {
    setupCardAbilities() {
        this.action({
            ...
            condition: () => this.game.currentConflict && this.game.currentConflict.isParticipating(this) && this.game.getOtherPlayer(this.controller).honor < this.controller.honor,
            handler: () => {
