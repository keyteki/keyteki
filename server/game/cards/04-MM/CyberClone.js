            ...
            target: {
                ...
                gameAction: ability.actions.sequential([
                    ...
                    ability.actions.cardLastingEffect(context => {
                        ...
                        effects = effects.concat(clone.traits.map(trait => ability.effects.addTrait(trait)));
                        effects = effects.concat(clone.getEffects('addKeyword').map(keyword => ability.effects.addKeyword(keyword)));
                        effects = effects.concat(clone.getEffects('removeKeyword').map(keyword => ability.effects.removeKeyword(keyword)));
