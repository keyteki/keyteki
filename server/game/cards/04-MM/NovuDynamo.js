...
class NovuDynamo extends Card {
    setupCardAbilities(ability) {
        this.interrupt({
            ...
            target: {
                activePromptTitle: { text: 'Destroy {{card}} or Discard a Logos Card', values: { card: 'Novu Dynamo' } },
                location: 'any',
                cardCondition: (card, context) => card === context.source || (card.hasHouse('logos') && (card.location === 'archives' || card.location === 'hand')),
                controller: 'self',
                gameAction: ability.actions.conditional({
                    ...
                    falseGameAction: ability.actions.sequential([
                        ...
                        ability.actions.conditional({
                            condition: context => context.target && context.target.location === 'discard',
