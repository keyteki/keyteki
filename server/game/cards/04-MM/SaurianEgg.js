        ...
        this.omni({
            ...
            then: {
                gameAction: ability.actions.sequentialForEach(context => {
                    let forEachCards = context.preThenEvents ? context.preThenEvents.filter(event =>
                        event.card.type === 'creature' && event.card.hasHouse('saurian')).map(event => event.card) : [];
                    ...
                    if(forEachCards.length === 1) {
                        ...
                        if(forEachCards[0].gigantic) {
                            ...
                            } else if(forEachCards[0].compositeParts.length === 1 && (forEachCards[1].id === forEachCards[0].compositeParts[0])) {
