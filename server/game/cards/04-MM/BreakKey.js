    ...
    setupCardAbilities(ability) {
        this.play({
            ...
            gameAction: ability.actions.unforgeKey(context => ({
                target: context.player.opponent && context.player.opponent.getForgedKeys() > context.player.getForgedKeys() ? context.player.opponent : [],
                choices: Object.keys(context.player.opponent.keys).filter(key => context.player.opponent.keys[key]) || []
            })),
            then: {
