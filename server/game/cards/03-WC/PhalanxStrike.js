...
class PhalanxStrike extends Card {
    setupCardAbilities(ability) {
        this.play({
            target: {
                cardType: 'creature',
                gameAction: ability.actions.dealDamage(context => ({ amount: context.player.creaturesInPlay.length }))
            },
            ...
            then: {
                ...
                then: {
                    ...
                    messageArgs: context => [context.player.creaturesInPlay.length,context.target]
                }
            }
        });
    }
