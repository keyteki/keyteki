...
class DealDamageAction extends CardGameAction {
    ...
    computeDefaultAmount(card, context) {
        return this.amount === null ? this.amountForCard(card, context) : this.amount;
    }

    getReplacementEvent(card, context, amount = this.computeDefaultAmount(card, context)) {
    ...
    getEvent(card, context, amount = this.computeDefaultAmount(card, context)) {
        const damageSource = this.damageSource || context.source;
